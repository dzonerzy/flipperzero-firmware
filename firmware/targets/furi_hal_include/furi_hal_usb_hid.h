...
static const uint16_t hid_asciimap[] = {
    ...
    HID_KEYBOARD_SEMICOLON | KEY_MOD_RIGHT_ALT, // @
    ...
    HID_KEYBOARD_GRAVE_ACCENT, // bslash
    ...
    HID_KEYBOARD_Y, // y
    HID_KEYBOARD_Z, // z
    HID_KEYBOARD_OPEN_BRACKET | KEY_MOD_LEFT_SHIFT | KEY_MOD_RIGHT_ALT, // {
    HID_KEYBOARD_GRAVE_ACCENT | KEY_MOD_LEFT_SHIFT, // |
    HID_KEYBOARD_CLOSE_BRACKET | KEY_MOD_LEFT_SHIFT | KEY_MOD_RIGHT_ALT, // }
    HID_KEYBOARD_NONE, // ~
    HID_KEYBOARD_NONE, // DEL
};
